#' Random forest classification model based on full length RSV genome sequences
#'
#' This a classification model (created with the ranger package) to use with the ReSVidex package
#'
#'
...
#' Random forest classification model based on partial RSV genome sequences
#'
#' This a classification model (created with the ranger package) to use with the ReSVidex package
#'
#'
