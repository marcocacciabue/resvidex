# Contributing to ReSVidex

Thank you very much for your interest and for taking the time to contribute!
...
[Contributor Code of Conduct](https://github.com/marcocacciabue/resvidex/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <marcocacciabue@yahoo.com>.
...
`ReSVidex` uses the `lower_snake_case`.
...
[Issues](https://github.com/marcocacciabue/ReSVidex/issues) that might help you. 
...
- Open a new [Issue](https://github.com/marcocacciabue/ReSVidex/issues/new).
...
- Make sure that you are using the latest version of `ReSVidex`.
- Determine if your bug is really a bug and not an error on your side.
- To see if other users have experienced (and potentially already solved) the 
same issue you are having, check if there is not already a bug report existing 
for your bug or error in the [bug tracker](https://github.com/marcocacciabue/ReSVidex/issues?q=label%3Abug).


### How do I submit a bug report?

We use [GitHub Issues](https://github.com/marcocacciabue/ReSVidex/issues) to track 
bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/marcocacciabue/ReSVidex/issues/new).
- Use the template [bug_report.md](https://github.com/marcocacciabue/ReSVidex/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `ReSVidex`.
- Read the [documentation](https://marcocacciabue.github.io/resvidex/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/marcocacciabue/ReSVidex/issues) to see if 
...
[GitHub Issues](https://github.com/marcocacciabue/ReSVidex/issues).

- Open a new [Issue](https://github.com/marcocacciabue/ReSVidex/issues/new).
- Use the template [feature_request.md](https://github.com/marcocacciabue/ReSVidex/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
- Provide a clear and descriptive title for the issue to identify the suggestion.
- Provide a step-by-step description of the suggested enhancement in as 
many details as possible.
- Explain why this enhancement would be useful to most `ReSVidex` users.
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/marcocacciabue/ReSVidex/compare).
